		          ...
		          <div class="mb-4">
		            ...
		            <div class="card-body">
		              <div class="table-responsive">
                        ...
                        $querymenu = "SELECT *
                                        FROM `rb_post` JOIN `rb_user_access_menu` 
                                        ON `rb_post`. `post_author` = `rb_user_access_menu`. `user`
                                        ";
                    ...
                    ?>
		                  <tbody>
		                    ...
		                    <tr>
                                <td><?=$i?></td>
                                <td><img src="<?= base_url('assets/images/') . $a['thumbnail'];?>" alt="thumbnail" style="width: 50px;" />
                                    </td>
		                      <td><?= $a['post_title'];?></td>
		                      <td><?= $a['post_author'];?></td>		                    
                              <td><?= $a['post_date'];?></td>
